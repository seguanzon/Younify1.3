...
function authorize() {
  const client_id = 'a707729d2dfb4539897a56a0f153d519';
  const redirect_uri = 'https://seguanzon.github.io/Younify1.2/';
  ...
  if (access_token) {
    $.ajax({
      ...
      data: JSON.stringify({
        ...
        description: 'created on ' + date + ' • seguanzon.github.io/Younify1.3/',
        public: false,
      }),
      headers: {
        'Authorization': 'Bearer ' + access_token,
